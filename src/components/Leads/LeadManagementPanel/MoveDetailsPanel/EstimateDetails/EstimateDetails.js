...
// Import the specialh.svg as a React component:
...
function EstimateDetails({
  ...
  // Keep local ESTIMATE state in sync with lead prop changes
  useEffect(() => {
  ...
  // Measure height of the Estimate section
  useEffect(() => {
              ...
              <div className={styles.buttonContainer}>
                ...
                >
                  ...
                  <div className={styles.viewEstimateIconWrapper}>
                    <SpecialhIcon className={styles.viewEstimateIcon} />
                  </div>
                </button>
              </div>
            </div>
